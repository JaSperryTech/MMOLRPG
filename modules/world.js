...
const createMonsters = () => {
  return {
    ...
    Goblin: {
      ...
      experience: 25,
      drops: createDrops([
        { name: "GoblinTeeth", chance: 0.3 },
        { name: "GoblinTrinket", chance: 0.3 },
        { name: "GoblinDagger", chance: 0.169 },
        { name: "GoblinMask", chance: 0.1 },
        { name: "GoblinBelt", chance: 0.1 },
        { name: "GoblinCloak", chance: 0.1 },
        { name: "GoblinRelic", chance: 0.1 },
        { name: "GoblinCharm", chance: 0.01 },
        { name: "GoblinSpellbook", chance: 0.001 },
      ]),
    },
    King_Slime: {
      name: "King Slime",
      ...
      drops: createDrops([
        ...
        { name: "SlimeCrystal", chance: 0.15 },
        { name: "SlimeScale", chance: 0.08 },
        { name: "SlimeCharm", chance: 0.02 },
        { name: "SlimeEssence", chance: 0.01 },
        { name: "KingSlimeCrown", chance: 0.01 },
        { name: "RoyalSlimeArmorPiece", chance: 0.01 },
        { name: "KingSlimeAmulet", chance: 0.01 },
        { name: "SlimeKingScepter", chance: 0.01 },
      ]),
    },
    King_Goblin: {
      name: "King Goblin",
      ...
      drops: createDrops([
        ...
        { name: "GoblinTrinket", chance: 0.3 },
        { name: "KingGoblinDagger", chance: 0.1 },
        { name: "KingGoblinCrown", chance: 0.04 },
        { name: "GoblinKingStaff", chance: 0.03 },
        { name: "KingGoblinAmulet", chance: 0.017 },
        { name: "GoblinCharm", chance: 0.012 },
        { name: "GoblinSpellbook", chance: 0.001 },
      ]),
    },
  };
